...
public class FollowingsAdapter extends RecyclerView.Adapter<FollowingsAdapter.FollowersHolder> implements ResponseCallBack {
    Context context;
    ArrayList<FollowBean> followBeanArrayList;
    RequestApiCall requestApiCall;
    public static boolean clickStatus= false;
    public FollowingsAdapter(Context context, ArrayList<FollowBean> followBeanArrayList) {
