...
//            getLocalVisibleRect(mCurrentViewRect);
//            int height = getHeight();
//            int width = getWidth();
////            sb.append(
////                    "ViewRect\ntop " + mCurrentViewRect.top +
////                            ", left " + mCurrentViewRect.left +
////                            ", bottom " + mCurrentViewRect.bottom +
////                            ", right " + mCurrentViewRect.right + "\n"
////            );
//
...
//            }
////            sb.append("size:  " + width + "*" + height + " visiblePercent: " + percents);
////            Log.d("@@@", sb.toString());
//        } catch (Exception e) {
//            return 0;
//        }
