...
public class ObservableGridView extends GridView implements Scrollable {
        ...
        if (mCallbacks != null || mCallbackCollection != null) {
            switch (ev.getActionMasked()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    // showResponse initializations which are related to ACTION_DOWN events should be executed.
    ...
    @Override
    public void setCurrentScrollY(int x) {
        Parcelable superState = super.onSaveInstanceState();
        SavedState ss = new SavedState(superState);
        mScrollY=x;
        ss.scrollY=mScrollY;
