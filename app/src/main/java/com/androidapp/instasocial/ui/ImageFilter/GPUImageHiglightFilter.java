...
public class GPUImageHiglightFilter extends GPUImageFilter {
    ...
    public GPUImageHiglightFilter() {
        this(0.0f, 1.0f);
    }

    public GPUImageHiglightFilter(final float shadows, final float highlights) {
